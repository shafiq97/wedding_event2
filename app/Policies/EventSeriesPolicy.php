...
class EventSeriesPolicy
{
     ...
     *
     * @param User $user
     * @param ServiceSeries $eventSeries
     *
     * @return Response
     */
    public function view(User $user, ServiceSeries $eventSeries): Response
    {
    ...
    public function createChild(User $user, ServiceSeries $eventSeries): Response
    {
     ...
     * @return Response
     */
    public function update(User $user, ServiceSeries $eventSeries): Response
    {
     ...
     * @return Response
     */
    public function delete(User $user, ServiceSeries $eventSeries): Response
    {
        return $this->deny();
    }
     ...
     * @return Response
     */
    public function restore(User $user, ServiceSeries $eventSeries): Response
    {
        return $this->deny();
    }
     ...
     * @return Response
     */
    public function forceDelete(User $user, ServiceSeries $eventSeries): Response
    {
        return $this->deny();
    }
}
