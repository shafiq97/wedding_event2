 ...
 *
 * @property-read Collection|Venue[] $events {@see ServiceSeries::events()}
 * @property-read ?ServiceSeries $parentEventSeries {@see ServiceSeries::parentEventSeries()}
 * @property-read Collection|ServiceSeries[] subEventSeries {@see ServiceSeries::subEventSeries()}
 */
class ServiceSeries extends Model
{
    use Filterable;
    use HasFactory;
    ...
    {
        return $this->hasMany(Venue::class, 'event_series_id')
            ->orderBy('started_at')
            ->orderBy('finished_at');
    }
