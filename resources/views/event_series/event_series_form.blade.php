...
@php
    ...
    /** @var \Illuminate\Database\Eloquent\Collection|\App\Models\ServiceSeries[] $allEventSeries */
@endphp
...
@section('content')
    <x-form method="{{ isset($eventSeries) ? 'PUT' : 'POST' }}"
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <x-form.row>
                    <x-form.label for="parent_event_series_id">{{ __('Part of the venue series') }}</x-form.label>
